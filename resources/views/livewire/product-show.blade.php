 ...
 --}}                </a>
            ...
            <div class="w-full mx-2 md:mx-4">
                ...
                <div class="flex flex-col md:flex-row md:items-center justify-between mt-6">
                    <div class="flex items-center text-xs text-gray-400 font-semibold space-x-2">
                        <div class="hidden md:block font-bold text-gray-900"></div>
                        <div class="hidden md:block">&bull;</div>
                        <div>{{ $product->created_at->diffForHumans() }}</div>
                        <div>&bull;</div>
                        <div>{{ $product->category->name }}</div>
                        <div>&bull;</div>
                        <div class="text-gray-900">{{ $product->movements()->count() }} Movimientos</div>
                    </div>
                    <div
    ...
    <div class="buttons-container flex items-center justify-between mt-6">
        <div class="flex flex-col md:flex-row items-center space-x-4 md:ml-6">
            <livewire:movement-add :product="$product" /> 
          {{--   @admin
                <livewire:set-status :idea="$product" />
            @endadmin --}}
